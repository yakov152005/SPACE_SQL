...
-- 5. שלוף את שמות החייזרים שהשתתפו במסע לפני שנת 2000
...
-- 6. מצא את המהירות המירבית של כלל חלליות הצי הגלקסי
SELECT MAX(max_speed) AS higher_max_speed
FROM ships;

-- 7. מצא את האוכלוסיה הממוצעת בכוכבי הלכת של כל מערכת השמש
SELECT constellation, AVG(population) AS avg_population
FROM planets
GROUP BY constellation;


-- 8. מצא עבור כל חייזר כמה פעמים ביקר בכל כוכב לכת
SELECT
    aliens.alien_name,
    planets.plant_name,
